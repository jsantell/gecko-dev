...
let { createPerformanceFront } = devtools.require("devtools/server/actors/performance");
let RecordingUtils = devtools.require("devtools/toolkit/performance/utils");
let TargetFactory = devtools.TargetFactory;
let {
  PMM_loadProfilerScripts, PMM_isProfilerActive, PMM_stopProfiler, sendProfilerCommand
} = devtools.require("devtools/toolkit/shared/profiler");
