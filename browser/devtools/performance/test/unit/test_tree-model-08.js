...
add_task(function test() {
  ...
  let frames = [
    new FrameNode("hello/<.world (http://foo/bar.js:123:987)", {
     ...
     new FrameNode("hello/<.world (http://foo/bar.js#baz:123:987)", {
    ...
    new FrameNode("hello/<.world (http://foo/#bar:123:987)", {
    ...
    new FrameNode("hello/<.world (http://foo/:123:987)", {
    ...
    new FrameNode("hello/<.world (resource://foo.js -> http://bar/baz.js:123:987)", {
    ...
    new FrameNode("EnterJIT", {
      location: "EnterJIT",
      isContent: FrameUtils.isContent({
        location: "EnterJIT"
      })
    }, false),
    new FrameNode("chrome://browser/content/content.js", {
      location: "chrome://browser/content/content.js",
      line: 456,
      column: 123
    }, false),
    new FrameNode("hello/<.world (resource://gre/foo.js:123:434)", {
      location: "hello/<.world (resource://gre/foo.js:123:434)",
      line: 456
    }, false),
    new FrameNode("main (http://localhost:8888/file.js:123:987)", {
    ...
    new FrameNode("main (resource://gre/modules/devtools/timeline.js:123)", {
