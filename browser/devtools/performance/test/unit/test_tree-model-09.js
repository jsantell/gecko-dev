...
let gThread = synthesizeProfileForTest([{
  ...
  frames: [
    ...
    { location: "http://content/A" },
    { location: "http://content/B" },
    { location: "fn (resource:///modules/devtools/timeline.js)" },
  ...
  frames: [
    ...
    { location: "fn (resource://gre/modules/devtools/promise.js)" }
  ]
}, {
  time: 5 + 20,
  frames: [
    { location: "(root)" },
    { location: "somefn (resource:///modules/devtools/framerate.js)" }
  ]
}]);
