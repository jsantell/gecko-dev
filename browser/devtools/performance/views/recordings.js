...
let RecordingsView = Heritage.extend(WidgetMethods, {
  ...
  initialize: function() {
    ...
    this._onClearRecordings = this._onClearRecordings.bind(this);
    ...
    PerformanceController.on(EVENTS.CLEAR_RECORDINGS, this._onClearRecordings);
  ...
  destroy: function() {
    ...
    PerformanceController.off(EVENTS.RECORDINGS_CLEARED, this._onClearRecordings);
