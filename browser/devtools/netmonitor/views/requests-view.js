...
RequestsMenuView.prototype = Heritage.extend(WidgetMethods, {
  ...
  destroy: function() {
    ...
    NetMonitorView.ContextMenu.destroy();
  ...
  selectRequest: function (id) {
    this.tableRenderer.selectRequest(id);
  },
  ...
  /**
   * Updates filter buttons based on RequestCollection filter state.
   */
